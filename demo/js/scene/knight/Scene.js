...
export class Scene {
    ...
    setupParticleSystems (){
        ...
        let emissionFactor = 40;
        let scale = 0.2;
        this.manager.addParticleSystem(this.setupEmbers(root, scale, emissionFactor * .35, true, positionOffset));
        this.manager.addParticleSystem(this.setupBaseFlame(root, scale, emissionFactor, true, positionOffset));
        this.manager.addParticleSystem(this.setupBrightFLame(root, scale, emissionFactor, true, positionOffset));

        emissionFactor = 10;
        scale = .3;
        positionOffset.set(9, 5, 0);
        this.manager.addParticleSystem(this.setupBaseFlame(root, scale, emissionFactor, false, positionOffset));
        this.manager.addParticleSystem(this.setupBrightFLame(root, scale, emissionFactor, false, positionOffset));
    }

    setupEmbers (root, scale, emissionFactor, simulateInWorldSpace, positionOffset) {
        ...
        positionOffset.add(new THREE.Vector3(5 * scale, -50 * scale, 0));    
        ...
        embersParticleSystem.addParticleStateInitializer(new Photons.RandomVelocityInitializer(
                                                         ...
                                                         new THREE.Vector3(-.02 * scale, .8 * scale, -0.2 * scale),
    ...
    setupBaseFlame (root, scale, emissionFactor, simulateInWorldSpace, positionOffset) {
        positionOffset = new THREE.Vector3().copy(positionOffset);
        ...
        baseFlameParticleSystem.addParticleStateInitializer(new Photons.SizeInitializer(
                                                            new Photons.RandomGenerator(THREE.Vector2,
                                                                                        ...
                                                                                        0.0, 0.0, false)));
        positionOffset.add(new THREE.Vector3(-35 * scale, -50 * scale, 10));    
        baseFlameParticleSystem.addParticleStateInitializer(new Photons.BoxPositionInitializer(
                                                            new THREE.Vector3(10, 10, 75),
                                                            positionOffset));
        baseFlameParticleSystem.addParticleStateInitializer(new Photons.RandomVelocityInitializer(
                                                            new THREE.Vector3(0.05 * scale, 0.3 * scale, 0.05 * scale),
                                                            new THREE.Vector3(-0.025 * scale, 0.6 * scale, -0.025 * scale),
       ...
       // baseFlameOpacityOperator.addElements([[0.0, 0.0], [0.3, 0.25], [0.3, 0.5], [0.0, 1.0]]);
        baseFlameOpacityOperator.addElements([[0.0, 0.0], [0.3, 0.2], [0.2, 0.4], [0.1, 0.6], [0.0, 1.0]]);
    ...
    setupBrightFLame (root, scale, emissionFactor, simulateInWorldSpace, positionOffset) {
        positionOffset = new THREE.Vector3().copy(positionOffset);
        ...
        positionOffset.add(new THREE.Vector3(-35 * scale, -50 * scale, 20));                                                     
        ...
        brightFlameParticleSystem.addParticleStateInitializer(new Photons.RandomVelocityInitializer(
                                                              new THREE.Vector3(0.02 * scale, 0.3 * scale, 0.02 * scale),
                                                              new THREE.Vector3(-0.01 * scale, 0.6 * scale, -0.01 * scale),
        ...
        brightFlameOpacityOperator.addElements([[0.0, 0.0], [0.6, 0.2], [0.2, 0.4], [0.1, 0.6], [0.0, 1.0]]);
